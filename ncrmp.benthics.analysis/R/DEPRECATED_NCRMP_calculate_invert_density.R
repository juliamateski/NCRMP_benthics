...
NCRMP_calculate_invert_density_DEPRECATED <- function(region, project = "NULL") {
  ...
  tmp <- NCRMP_make_weighted_invert_density_data_DEPRECATED(inputdata = diadema_density_site,
                                                region,
                                                project)
